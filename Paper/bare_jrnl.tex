...
\begin{enumerate}
    ...
    \item Minimizing loss: weights of the CNN are frozen, but the corresponding importance scores are updated as the loss is minimized. If k weights are to be kept in the end, only top k importance weights will be used in predictions. However, all scores are updated in the backwards pass.
...
Bring up ANOVA results for both mAP and time
...
\begin{table}[htbp]
    \caption{p-value from ANOVA test between DeepLIFT and Scaled initialization}
    \begin{center}
    \begin{tabular}{ |p{2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|p{1.2cm}|  }
     \hline
     Pruning ratio  & 0\% & 25\%& 50\%& 65\%& 75\%& 85\%& 90\%& 95\%& 99\%\\
     \hline
     Unstructured   & 1.03e-01& 9.53e-02& 1.71e-03& 3.60e-04& 1.57e-06& 1.64e-04& 2.43e-02& 3.54e-02& 1.86e-01 \\
     Structured     & 1.48e-02& 3.60e-02& 1.18e-05& 1.24e-05& 6.91e-04& 1.17e-02& 8.99e-02& 8.87e-03& 5.80e-02\\
     \hline
    \end{tabular}
    \end{center}
    \label{tab:map}
